                                    ...
                                    <div className='list__product__actions'>
                                        ...
                                        <Link to=''>
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M20.5925 6.76003L23.24 9.40628M22.295 4.42878L15.1363 11.5875C14.7664 11.9569 14.5141 12.4275 14.4113 12.94L13.75 16.25L17.06 15.5875C17.5725 15.485 18.0425 15.2338 18.4125 14.8638L25.5713 7.70503C25.7864 7.48991 25.957 7.23452 26.0734 6.95345C26.1899 6.67238 26.2498 6.37113 26.2498 6.0669C26.2498 5.76267 26.1899 5.46143 26.0734 5.18036C25.957 4.89929 25.7864 4.6439 25.5713 4.42878C25.3561 4.21366 25.1007 4.04301 24.8197 3.92659C24.5386 3.81017 24.2374 3.75024 23.9331 3.75024C23.6289 3.75024 23.3276 3.81017 23.0466 3.92659C22.7655 4.04301 22.5101 4.21366 22.295 4.42878Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                                <path d="M23.75 18.75V22.5C23.75 23.163 23.4866 23.7989 23.0178 24.2678C22.5489 24.7366 21.913 25 21.25 25H7.5C6.83696 25 6.20107 24.7366 5.73223 24.2678C5.26339 23.7989 5 23.163 5 22.5V8.75C5 8.08696 5.26339 7.45107 5.73223 6.98223C6.20107 6.51339 6.83696 6.25 7.5 6.25H11.25" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </Link>
                                    </div>
                                </div>
