...
const ProductCard = ({id, image, title, price, quantity}: productCardProps) => {
    // const [updateIsInCart, setUpdateIsInCart] = useState<boolean>();
    function addToCartHandler(){
        ...
        // setUpdateIsInCart(true);
    }
    // console.log(CartController.isInCart(id));
    ...
    return(
        <div className='product__card'>
            ...
            <div className='product__card__actions'>
                <button  className={CartController.isInCart(id) ? 'add__to__cart incart__button' : 'add__to__cart'} disabled={CartController.isInCart(id) ? true : false} onClick={()=>addToCartHandler()}>В корзину</button>
                <button>
